...
|ID| Restrição                                             |
|--|-------------------------------------------------------|
|01| O projeto deverá ser entregue até a data 07/07/2020.|
|02| O aplicativo deve utilizar às tecnologias da Web no Frontend        |
|03| A equipe não pode contratar um programador para auxiliar no trabalho.      |
